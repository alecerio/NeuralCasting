...
class DequantizeLinear(OpNode):
    ...
    def generate_code(self) -> str:
        ...
        code : str = self._read_template_c("DequantizeLinear.c")
        ...
        code = self._expand_pattern(code, "$(SCALING_FACTOR_NAME)", input_scale)
        code = self._expand_pattern(code, "$(ZERO_NAME)", input_zero)
    ...
    def generate_declaration_code_c(self) -> str:
        ...
        code : str = self._read_template_c("DequantizeLinear_decl.c")
    ...
    def generate_includes_code_c(self) -> str:
        code : str = self._read_template_c("DequantizeLinear_inc.c")
        return code