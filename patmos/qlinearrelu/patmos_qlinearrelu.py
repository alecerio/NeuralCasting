...
from wcet.qlinearrelu.wcet_qlinearrelu import generate_input_c, generate_input_h, generate_int16_str
...
def qlinearrelu_patmos_analysis(name, size, acctype):
    def generate_c_code():
...
if __name__ == '__main__':
    qlinearrelu_patmos_analysis(name="qlinear_relu", size=100, acctype="int32_t")
