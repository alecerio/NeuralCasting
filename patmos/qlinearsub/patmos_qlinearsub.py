...
from wcet.qlinearsub.wcet_qlinearsub import generate_input_c, generate_input_h
...
def qlinearsub_patmos_analysis(name, size):
    def generate_c_code():
...
if __name__ == '__main__':
    qlinearsub_patmos_analysis(name="qlinear_sub", size=100)
