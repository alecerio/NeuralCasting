...
from wcet.qlinearmatmul.wcet_qlinearmatmul import generate_input_c, generate_input_h, generate_int16_str
...
def qlinearmatmul_patmos_analysis(name, M, K, N, Q, acctype):
    def generate_c_code():
...
if __name__ == '__main__':
    qlinearmatmul_patmos_analysis(name="qlinear_matmul", M=10, K=10, N=10, Q=15, acctype="int32_t")
