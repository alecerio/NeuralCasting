...
class QLinearAdd(OpNode):
    ...
    def generate_code(self) -> str:
        ...
        code : str = self._read_template_c("QLinearAdd.c")
    ...
    def generate_includes_code_c(self) -> str:
        code : str = self._read_template_c("QLinearAdd_inc.c")
        return code
    ...
    def generate_declaration_code_c(self) -> str:
        ...
        code : str = self._read_template_c("QLinearAdd_decl.c")
    ...
    def infer_output_shape(self) -> list[list[int]]:
        ...
        return infer_output_shape_for_element_wise_binary_operators(input1, input2, "QLinearAdd")
