from wcet.common.common import generate_main_wcet_template, generate_input_h_template, generate_input_c_template, generate_wcet_analysis, generate_int32_str

def generate_main(size):
    f = generate_int32_str
    nn_statement = f"NC_QTANH_FXS8(xq,yq,{size},{f()},{f()})"
...
def qlineartanh_wcet_analysis(name, size):
    def generate_c_code():
        generate_main(size)
...
if __name__ == '__main__':
    qlineartanh_wcet_analysis(name='qlineartanh_test', size=100)
