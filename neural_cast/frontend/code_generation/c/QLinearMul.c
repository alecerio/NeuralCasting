...
// QLINEARMUL OPERATOR $(NAME)

{
float32_t saby = (tensor_$(INPUT_SA)[0] * tensor_$(INPUT_SB)[0]) / tensor_$(INPUT_SY)[0];
...
int32_t res_i = ((int32_t)NCAST_ROUND(saby * qaz_i * qbz_i)) + (int32_t)tensor_$(INPUT_ZY)[0];
