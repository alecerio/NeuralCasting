...
from wcet.qlinearsigmoid.wcet_qlinearsigmoid import generate_input_c, generate_input_h
...
def qlinearsigmoid_patmos_analysis(name, size):
    def generate_c_code():
...
if __name__ == '__main__':
    qlinearsigmoid_patmos_analysis(name="qlinear_sigmoid", size=100)
