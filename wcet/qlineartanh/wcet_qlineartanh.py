from wcet.common.common import generate_main_wcet_template, generate_input_h_template, generate_input_c_template, generate_wcet_analysis, generate_int16_str
...
def qlineartanh_wcet_analysis(name, size, acctype):
    def generate_c_code():
...
if __name__ == '__main__':
    qlineartanh_wcet_analysis(name='qlineartanh_test', size=100, acctype="int32_t")
